<%
    ...
    if(acao.equals("Excluir")) {
        try {
                ...
                mensagem="Abiotico ExcluÃ­do com Sucesso";

                connection.close();
            } catch (SQLException sqle) {
                mensagem = "Ocorreu um erro ao alterar o AbiÃ³tico. Entre em contato com o Administrador do Sistema. Erro: <br/>" + sqle;
...
%>
		...
		%>
        <% while(abiotico.next()) { %>
        <form method="post" id="cadastro" action="index.jsp?abioticoDel&idAbiotico=<%out.print(abiotico.getString("id"));%>">
            <fieldset>
                <legend>Dados AbiÃ³ticos</legend>
