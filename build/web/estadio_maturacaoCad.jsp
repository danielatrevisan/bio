<%
    ...
    if(acao.equals("Salvar")) {
        try {
                ...
                mensagem = "Estádio de Maturação Cadastrado com Sucesso";

                connection.close();
            } catch (SQLException sqle) {
                mensagem = "Ocorreu um erro ao cadastrar estádio da maturação. Entre em contato com o Administrador do Sistema. Erro: <br/>" + sqle;
