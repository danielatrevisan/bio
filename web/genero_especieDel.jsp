...
out.println(sql);
                ...
                mensagem = "Gênero/Espécie excluído com sucesso";
...
<form method="post" id="cadastro" action="index.jsp?url=genero_especieDel">
    <fieldset>
        ...
        <p>        
            <label for="cObs">Observações: </label><textarea id="cObs" name="tObs" rows="10" cols="50" maxlength="1000" readonly><%out.print(genero_especie.getString("observacoes"));%></textarea>
        </p>
