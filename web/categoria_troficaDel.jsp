    ...
    if(acao.equals("Excluir")) {
        try {
               connection = PosFactory.getConnection();	
                ...
                mensagem = "Ctrof excluída com sucesso";
...
<form method="post" id="cadastro" action="index.jsp?url=categoria_troficaDel">
    <fieldset>
        ...
        <p>        
            <label for="cObs">Observações: </label><textarea id="cObs" name="tObs" rows="10" cols="50" maxlength="1000" readonly><%out.print(ctrof.getString("observacoes"));%></textarea>
        </p>
