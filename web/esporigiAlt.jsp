<%
    ...
    String nEsporigiAgrupada= request.getParameter("nEsporigiAgrupada");
    ...
    if(acao.equals("Salvar")) {
        try {
               connection = PosFactory.getConnection();	
                ...
                sql = "update esporigi set nome='"+nNome+"', especie_agrupada_id = '"+nEsporigiAgrupada+"', observacoes='"+nObs+"' where id="+idEsporigi;
...
<form method="post" id="cadastro" action="index.jsp?url=esporigiAlt">
    <fieldset>
      ...
      <p>
        ...
        <label for="especieAgrupadaId">Esporigi Agrupada: </label>
        <%
        ...
        %>
        <select name="nEsporigiAgrupada" id="especieAgrupadaId">
        <%while(especieAgrupada.next()) { %>
            <%if(esporigi.getString("especie_agrupada_id").equals(especieAgrupada.getString("id")))
            {%>
