<%
    ...
    if(acao.equals("Pesquisar")) {
        try {
                ...
                sql = "select e.id, e.nome, ea.nome as spgroup from especie e left join especie_agrupada ea on e.especie_agrupada_id = ea.id where upper(e.nome) like upper('%"+cNome+"%')";
