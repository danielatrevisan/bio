<%
    ...
    if(acao.equals("Salvar")) {        
        try {
                ...
                sql = "insert into abiotico (local_coleta_id, planc, data_coleta, hora, margem, smf, ativ, vento, nebulosidade, chuva, tar, tagua, transp, ph, cond)"
                        + "values ('" +tLocalColeta+"','" + tPlanc+"','" +tDataColeta+"','" + tHora+"','" + tMargem+"','" + tSMF+"','" + tAtividade+"','" + tVento+"','" + tNebulosidade+"','" + tChuva+"','" + tTar+"','" + tAgua+"','" + tTransp+"','" + tPh+"','" + tCond+"')"; 
