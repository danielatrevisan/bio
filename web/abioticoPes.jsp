   ...
   try { 
    Date today = new Date();  
        ...
        try { 
                ...
                mensagem = "<table> <tr> <td class='td_g'><b>Id</b></td> <td class='td_g'><b>Proj</b></td> <td class='td_g'><b>Amostra</b></td> <td class='td_g'><b>Planc</b></td> <td class='td_g'><b>Rede</b></td> <td class='td_g'><b>Local</b></td> <td class='td_g'><b>Data da Coleta</b></td> <td class='td_g'><b>Hora</b></td> <td class='td_g'><b>Margem</b></td> <td class='td_g'><b>SMF</b></td> <td class='td_g'><b>Ativ</b></td> <td class='td_g'><b>Vento</b></td> <td class='td_g'><b>Nebulosidade</b></td> <td class='td_g'><b>Chuva</b></td> <td class='td_g'><b>Tar</b></td> <td class='td_g'><b>Tagua</b></td> <td class='td_g'><b>Profund</b></td> <td class='td_g'><b>ODmg</b></td><td class='td_g'><b>Transp</b></td> <td class='td_g'><b>PH</b></td> <td class='td_g'><b>Cond</b></td><td></td> </tr>";
                       
               
                 abiotico = stmt.executeQuery(); 
		  while(abiotico.next()) {
                    mensagem = mensagem + "<tr> <td class='td_g'>"+abiotico.getString("id")+" </td> <td class='td_g'>"+abiotico.getString("projeto")+" </td> <td class='td_g'>"+abiotico.getString("amostra")+" </td> <td class='td_g'>"+abiotico.getString("planc")+" </td> <td class='td_g'>"+abiotico.getString("rede")+" </td> <td class='td_g'> "+abiotico.getString("local")+"</td> <td class='td_g'> "+abiotico.getString("data_coleta")+"</td> <td class='td_g'>"+abiotico.getString("hora")+" </td> <td class='td_g'>"+abiotico.getString("margem")+" </td><td class='td_g'> "+abiotico.getString("smf")+"</td> <td class='td_g'>"+abiotico.getString("ativ")+" </td> <td class='td_g'>"+abiotico.getString("vento")+" </td> <td class='td_g'>"+abiotico.getString("nebulosidade")+" <td class='td_g'>"+abiotico.getString("chuva")+" <td class='td_g'>"+abiotico.getString("tar")+" </td> <td class='td_g'>"+abiotico.getString("tagua")+" </td> <td class='td_g'>"+abiotico.getString("profundidade")+" </td> <td class='td_g'>"+abiotico.getString("odmg")+" </td> <td class='td_g'>"+abiotico.getString("transparencia")+" </td> <td class='td_g' >"+abiotico.getString("ph")+" </td> <td class='td_g'>"+abiotico.getString("condutividade")+" </td> <td class='td_g'> <a href='index.jsp?url=abioticoAlt&idAbiotico="+abiotico.getString("id")+"'>Alterar</a>"+" | "+"<a href='index.jsp?url=abioticoDel&idAbiotico="+abiotico.getString("id")+"'>Excluir</a></p></td> </tr>";                    
                }
