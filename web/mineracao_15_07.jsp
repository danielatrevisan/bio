...
*/
		dado.setOptions(weka.core.Utils
				.splitOptions("-N 20 -T 0 -C 0.1 -D 0.05 -U 1.0 -M 0.1 -S -1.0 -c -1"));
		...
		<fieldset>
			...
			<table width="449" border="1">
				<tr>
					...
					%> <select name="nLocal" id="localId" size="5"
							multiple="MULTIPLE">
				...
				<tr>
					...
					<td><label for="periodoIni">Data inicial:<br/> 
					<input id="tPeriodoIni" name="tPeriodoIni" type="text" placeholder="dd/mm/yyyy" /></td>
					<td><label for="periodoFim">Data final:<br/> 
					<input id="tPeriodoFim" name="tPeriodoFim" type="text" placeholder="dd/mm/yyyy" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="checkbox" name="nAmbiente" value="" />Projeto</td>
					<!-- Ver se realmente justifica o projeto fazer parte da mineração-->
					<td><input type="checkbox" name="nHorario" value="" />Horário</td>
					<!-- Será que seria interessante discretizar o horário em período?-->
				...
				<tr>
					...
					<td><input type="checkbox" name="nTagua" value="" />Temperatura
						da &aacute;gua</td>
				</tr>
				<tr>
					<td><input type="checkbox" name="nTar" value="" />Temperatura
						do ar</td>
		...
		<fieldset>
			...
			<table width="449" border="1">
				<tr>
					...
					<td>Confiança <input name="conf" type="text" value="0.9" />
					</td>
				</tr>
				<tr>
					<td>Nº de Regras <input name="regras" type="text" value="10" />
					</td>
					<td>Suporte M&iacute;nimo <input name="sup" type="text"
						value="0.1" />
					</td>
				</tr>
			</table>
